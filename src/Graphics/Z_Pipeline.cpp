...
namespace ze {
	...
	void ZePipeline::defaultPipelineConfigInfo( PipelineConfigInfo& configInfo, uint32_t width, uint32_t height)
	{
	...
	void ZePipeline::createGraphicsPipeline(const std::string& vertFilePath, const std::string& fragFilePath, const PipelineConfigInfo& configInfo)
	{
		...
		pipelineInfo.pDynamicState = nullptr; // coming back to this later
